...
var (
	...
	// 题目相关错误
	ErrQuestionNotFound   = errors.New("ERR_QUESTION_NOT_FOUND")   // 未找到题目
	ErrSubmissionNotFound = errors.New("ERR_SUBMISSION_NOT_FOUND") // 未找到答题记录
	ErrInvalidPoints      = errors.New("ERR_INVALID_POINTS")       // 分值不合法
	ErrEmptyAnswer        = errors.New("ERR_EMPTY_ANSWER")         // 答案为空
	ErrInvalidQuestionID  = errors.New("ERR_INVALID_QUESTION_ID")  // 非法题目ID
	...
	// 用户相关错误
	ErrInvalidUserID      = errors.New("ERR_INVALID_USER_ID")      // 非法用户ID
